 ...
 */
 ...
 /* По умолчанию, MySQL настроен на общение с виндовой консолью в кодировке cp866. Этот же файл - в кодировке cp1251. Поскольку мы не хотим менять кодировку и/или шрифт консоли из-за того чтобы сервер корректно принял файл cp1251 - мы сменим кодировку сервера только на время транзакции и вернём её назад в конце - для того чтобы он снова отдавал в 866 - чтобы в выхлопе select не было крякозябр - см. конец файла*/
